...
from mlcore.pipeline.stage_01_data_ingestion import DataIngestionTrainingPipeline
...
from mlcore.pipeline.stage_04_model_trainer import ModelTrainerTrainingPipeline
