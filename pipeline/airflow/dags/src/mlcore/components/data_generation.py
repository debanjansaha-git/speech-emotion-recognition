...
class DataGeneration:
    ...
    def download_metadata(self):
        ...
        metadata_files = [blob.name for blob in metadata_bucket.list_blobs(prefix=str(self.config.gcp_data_path))]
    ...
    def train_test_split(self):
        ...
        metadata_train.to_csv(new_metadata_file_path)
    ...
    def copy_files_to_test_dir(self, files_to_copy):
        ...
        for idx, path in enumerate(files_to_copy):
            shutil.copyfile(path, self.config.test_dir)
            count = idx + 1
